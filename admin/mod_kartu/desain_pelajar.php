                ...
                <div class='box-body'>
                    <div class="alert bg-green alert-dismissible">
                        ...
                        <div class="box-body">
                            ...
                            untuk contoh desain silahkan dowload <a target="blank" href="../assets/img/pelajar.png">disini</a>
                        </div>
                    </div>
                    <form id="form-desain">
                        ...
                        <div class='box-body'>
                            <div class='form-group'>
                                ...
                                <div class='col-sm-6'>
                                    <img class="img-responsive img-thumbnail" alt="Responsive image" src="../<?= $b['desain_pelajar'] ?>" width="5300px">
                                </div>
                            </div>
                            <div class='form-group'>
                                <label class='col-sm-3 control-label'>Ganti Desain Baru:</label>
                                <div class='col-sm-6'>
                                    <input type='file' class='form-control' name='desain_pelajar'>
                                </div>
                            </div>
                            <div class='form-group'>
...
<script>
    ...
    $('#form-desain').on('submit', function(e) {
        ...
        $.ajax({
            type: 'post',
            url: 'mod_kartu/crud_pelajar.php?pg=ubah',
