...
<html>
	<head>
		<title>Formulir_SIDADIK<?= $siswa['nama'] ?></title>
	</head>
	<body>
    ...
    <body>
        ...
        <hr>
		<b><center>Formulir Pensiswaan Peserta Didik Baru Tahun 2021</center></b>
		<br>
			...
			<tr>
				<td width="5%"></td>
				<td width="35%" align="">Jenis Pensiswaan</td>
			...
			<tr>
				<td></td>
				<td align="">Jalur Pensiswaan</td>
				<td align="center">:</td>
				<td align="left">umum</td>
			</tr>
			<tr>
				<td></td>
				<td align="">Nomor Pensiswaan</td>
				<td align="center">:</td>
				<td align="left"><?= $siswa['no_siswa'] ?> (Diisi Panitia)</td>
			</tr>
...
$dompdf->render();
$dompdf->stream("SIDADIK2021_" . $siswa['nama'] . ".pdf", array("Attachment" => false));
exit(0);
?>