...
<head>
	...
	<!--begin::Web font -->
	<script src="https://ard.ma.nwkaltara.web.id/assets/mtc/app/js/webfont.js" type="text/javascript"></script>
	<script>
		WebFont.load({
	...
	<link href="https://ard.ma.nwkaltara.web.id/assets/mtc/vendors/base/vendors.bundle.css" rel="stylesheet" type="text/css" />
	<!--RTL version:<link href="assets/vendors/base/vendors.bundle.rtl.css" rel="stylesheet" type="text/css" />-->
	<link href="https://ard.ma.nwkaltara.web.id/assets/mtc/demo/demo3/base/style.bundle.css" rel="stylesheet" type="text/css" />
	<!--RTL version:<link href="assets/demo/demo3/base/style.bundle.rtl.css" rel="stylesheet" type="text/css" />-->

	<link href="https://ard.ma.nwkaltara.web.id/assets/mtc/vendors/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css"/>

	<!--end::Global Theme Styles -->

	<!--begin::Page Vendors Styles -->
	<link href="https://ard.ma.nwkaltara.web.id/assets/mtc/vendors/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" href="../assets/modules/izitoast/css/iziToast.min.css">
	...
	<link rel="stylesheet" href="https://ard.ma.nwkaltara.web.id/assets/css/custom.css">
	<script src="https://ard.ma.nwkaltara.web.id/assets/mtc/vendors/base/vendors.bundle.js" type="text/javascript"></script>
	<script src="https://ard.ma.nwkaltara.web.id/assets/mtc/demo/demo3/base/scripts.bundle.js" type="text/javascript"></script>
			<style>
			body{
				color : white;
...
<body >
	<div class="row" style="height: 90%;width: 100%;padding: 10% 13% 13% 13%;">
		...
		<div class="col-lg-5 col-md-12 col-sm-12 col-12" style="color:grey;background:#ececec;box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.3)">
			...
			<div align="right">
				copyright &copy; Ajat Sudrajat
			</div>
		</div>
		<div class="col-lg-1">
		</div>
	</div>
	<script src="https://ard.ma.nwkaltara.web.id/assets/js/sweetalert.min.js" type="text/javascript"></script>
